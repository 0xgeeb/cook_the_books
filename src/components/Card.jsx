...
export default function Card(x) {
  ...
  function profitAmount(homeLine, awayLine) {
    let profit = formatter.format(1000 - ((1000 / homeLine) + (1000 / awayLine)));
    return profit
  }
  ...
  return (
    <div className="bg-[#F7F7F7] h-[400px] w-[550px] flex flex-col shrink-0 mb-96 mr-10 ml-2 mt-2 rounded" key={x.home.id} id="card-div-shadow">
      ...
      <h2 className="mx-auto text-lg mt-2 mb-5 border-b-2 border-gray-200"><b>{profitAmount(x.home.line, x.away.line)}</b> profit on a total bet of <b>${((1000 / x.home.line) + (1000 / x.away.line)).toFixed(2)}</b></h2>
    </div>
  )
}